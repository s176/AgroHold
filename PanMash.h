#ifndef _AgroHold_PanMash_h_
#define _AgroHold_PanMash_h_

class PanMachinery : public WithPanelLayout<ParentCtrl> {
...
public:        	
    ...
    typedef PanMachinery CLASSNAME;
 	PanMachinery()
 	{
 		CtrlLayout(*this);	
 		Add(grid.SizePos());
 		TableName = "Machinery";
		grid.AddIndex(ID);
		grid.AddColumn("Марка машини", 200).Edit(edName);
